...
import { StyleSheet, Text, View, SafeAreaView, Dimensions, StatusBar, ScrollView, Pressable } from 'react-native';
...
export default function MilestoneScreen({ route, navigation }) {
  return (
		<SafeAreaView style={styles.container}>
      <Header title="Milestones overdue" amount={route.params.amount} />
